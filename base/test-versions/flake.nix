                  ...
                  test : versions :
                    {
                      devShell =
                        let
                          ...
                          in pkgs.mkShell
                            {
			      buildInputs = [ ( builtins.trace ( "YES - ${ builtins.typeOf versions } - ${ builtins.typeOf ( builtins.mapAttrs mapper versions ) } - ${ builtins.typeOf ( builtins.attrValue ( builtins.mapAttrs mapper versions ) ) }" ) ( pkgs.writeShellScriptBin "test" "" ) ) ] ;
                              buildInputs2 =
